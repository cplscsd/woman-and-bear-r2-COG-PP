            ...
            <div className="slide-container">
                ...
                <div className="slide fade" style={{display: "flex"}}>
                    <div className="image-container">
                        ...
                        The family is the most important unit in Inuit society. During the winter about 5 to 10 families would gather together.  Within the family, the men and the women performed important jobs. The men usually did the hunting. The women usually prepared the food and then used the skins and furs to make clothing and tents. The women also distributed food to other families in the group. Sharing is an important part of Inuit culture. 
                        </div>
                    </div>
